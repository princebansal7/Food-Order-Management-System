...
int main(){
	...
	system("title .........Food Order Management System - 20223069_PRINCE.......................");
	...
	insertend(9,"Cold Drink",73,20.13);
...
void pwellcome(){
	...
	char welcome2[50]=" TO";
	char welcome3[50]=" FOOD ORDER MANAGEMENT SYSTEM";
	char welcome4[50]="  - PRINCE";
	printf("\n\n\n\n\n\t\t\t\t    ");
